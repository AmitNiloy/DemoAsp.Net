<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="WebStudent.WebForm1" %>
...
<body>  
    <form id="form1" runat="server"  >  
        ...
        <div style="background-image:url('n.jpg');">  
            <h1 style="text-align: center; background-color: #99FF66">                       Registration Form </h1>
            <table class="auto-style1" align="center">  
                ...
                <tr>  
                    ...
                    <td class="auto-style6">  
                        <asp:DropDownList ID="DropDownList1" runat="server"  CssClass="auto-style14" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="ID">  
                           
                             
                        </asp:DropDownList>  
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:webDBConnectionString %>" SelectCommand="Semister_dropdown" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                    </td>  
                </tr>  
